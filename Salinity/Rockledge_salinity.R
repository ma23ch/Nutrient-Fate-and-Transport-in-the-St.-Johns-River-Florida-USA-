...
# import salinity
saldat <- read.csv("C:/Users/ma23ch/OneDrive - Florida State University/Desktop/WRTDS/Salinity/Rockledge_salinity.csv") |> 
...
# import nutrients
nutdat <- read.csv("C:/Users/ma23ch/OneDrive - Florida State University/Desktop/WRTDS/Water Quality/TKN_Rockledge.csv") |> 
