...
# import salinity
saldat <- read.csv("C:/Users/ma23ch/OneDrive - Florida State University/Desktop/WRTDS/Salinity/CowCreek_Salinity.csv") |> 
...
# import nutrients
nutdat <- read.csv("C:/Users/ma23ch/OneDrive - Florida State University/Desktop/WRTDS/Water Quality/TKN_CowCreek.csv") |> 
