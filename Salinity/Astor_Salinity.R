...
# import salinity
saldat <- read.csv("C:/Users/ma23ch/OneDrive - Florida State University/Desktop/WRTDS/Salinity/Astor_Salinity.csv") |> 
...
# import nutrients
nutdat <- read.csv("C:/Users/ma23ch/OneDrive - Florida State University/Desktop/WRTDS/Water Quality/TKN_Astor.csv") |> 
...
totidal <- intdat|> 
  ...
  tidalmean(reslog = T, reslab = ylb, flolab = 'Sal ff')
