...
filePath1  <- "F:/St Johns DEM/Data Briona/WRTDS Run Data/"
fileName1  <- "TKN_StAugustine.CSV"

fileNamein <- "TKN_StAugustine_Info.csv"
...
# -----------------------------
INFO <- readUserInfo(filePath, fileNamein)
