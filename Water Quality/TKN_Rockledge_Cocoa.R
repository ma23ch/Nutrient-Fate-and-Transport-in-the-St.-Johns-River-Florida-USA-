...
fileName1  <- "TKN_Rockledge.CSV"

fileNamein <- "TKN_Rockledge_Info.csv"
...
tiff(file.path(outdir, "TKN_Rockledge_ConcHist.tif"),
...
tiff(file.path(outdir, "TKN_Rockledge_FluxHist.tif"),
     units = "in", width = 6.5, height = 5.0, res = 600,
...
plotFluxHist(eList, printTitle = FALSE, fluxUnit = 5)  # same unit you’re using
dev.off()
