...
tiff(file.path(outdir, "TKN_Astor_ConcHist.tif"),
...
# ---- Flux histogram ----
tiff(file.path(outdir, "TKN_Astor_FluxHist.tif"),
     units = "in", width = 6.5, height = 5.0, res = 600,
