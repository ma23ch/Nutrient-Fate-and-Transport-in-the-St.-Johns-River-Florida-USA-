...
fileName1  <- "TP_Jacksonville.CSV"

fileNamein <- "TP_Jacksonville_Info.csv"
...
tiff(file.path(outdir, "TP_Jacksonville_ConcHist.tif"),
...
old_opts <- options(scipen = 999)  # large bias against scientific notation
# ---- Flux histogram ----
tiff(file.path(outdir, "TP_Jacksonville_FluxHist.tif"),
     units = "in", width = 6.5, height = 5.0, res = 600,
